...
export function AddEditions(props) {
  ...
  const { editions = [], loading: editionsLoading } =
    useEditionCollectionData();
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const finalFormat =
        existingFormat || editionForm.format || editionForm.formatName || null;
  ...
  return (
    <>
      ...
      >
        ...
        <Modal.Body>New comic / edition has been added</Modal.Body>
