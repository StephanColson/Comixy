          ...
          <Col lg={5} className="mt-3">
            ...
            <Combobox
              value={
                ...
                (contributorDraft.peopleName
                  ? { name: contributorDraft.peopleName }
                  : null)
              }
              onChange={(opt) => {
                if (!opt) {
              ...
              <Combobox.Options className="list-group position-absolute z-3">
                ...
                {searchQuery.person !== "" &&
                  !filteredPersons.some(
                    (p) =>
                      p.name.toLowerCase() === searchQuery.person.toLowerCase(),
                  ) && (
                    <Combobox.Option
          ...
          <Col lg={5} className="mt-3">
            ...
            <Combobox
              value={
                ...
                (contributorDraft.roleName
                  ? { type: contributorDraft.roleName }
                  : null)
              }
              onChange={(opt) => {
                if (!opt) {
            ...
            >
              ...
              <Combobox.Options className="list-group position-absolute z-3">
                ...
                {searchQuery.role !== "" &&
                  !filteredRoles.some(
                    (r) =>
                      r.type.toLowerCase() === searchQuery.role.toLowerCase(),
                  ) && (
                    <Combobox.Option
      ...
      <div className="d-flex justify-content-center">
        <Row className="m-4">
          ...
          {contributors.length === 0 && (
            <Col className="text-warning text-center py-2">
