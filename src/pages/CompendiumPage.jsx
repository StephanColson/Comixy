...
export function CompendiumPage(props) {
    const {compendium, editions, onEditEdition, comics, series, organizations, roles, peoples, comicContributors} = props;

    const compendiumEditions = editions?.filter(ed => ed.compendiumID === compendium.id) ?? [];
