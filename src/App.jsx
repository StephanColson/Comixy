    ...
    <>
      <Navbar expand="md" className="fixed-top nav-bg">
        <Container fluid>
          ...
          >
            <Nav
              activeKey={activeNavBarItem}
              onSelect={(selectedEventKey) =>
                onSelectNavBarItem(selectedEventKey)
              }
              className="me-auto"
            >
              <Nav.Item>
              ...
              <Nav.Item>
                <Nav.Link className="nav-text" eventKey={NAV_UNIVERSE_CATALOG}>
                  Universe Catalog
                </Nav.Link>
              </Nav.Item>
              ...
              <Nav.Item>
                <Nav.Link className="nav-text" eventKey={NAV_ADD_FORM}>
                  Add Comics
                </Nav.Link>
              </Nav.Item>
            </Nav>
...
function ActivePage(props) {
  ...
  switch (activeNavBarItem) {
    ...
    case NAV_COLLECTION: {
      const selectedCompendium = compendium?.find(
        (c) => c.id === selectedCompendiumID,
      );
      return (
        <CompendiumPage
    ...
    case NAV_PUBLISHER: {
      const selectedPublisher = organizations?.find(
        (o) => o.id === selectedPublisherID,
      );
      return (
